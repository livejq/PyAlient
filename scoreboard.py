...
class Scoreboard():
    ...
    def __init__(self, ai_settings, screen, status):
        ...
        self.font = pygame.font.Font('font/STKAITI.TTF', 32)
    ...
    def prep_score(self):
        ...
        self.score_image = self.font.render("总分: "+score_str, True, self.text_color, 
    ...
    def prep_level(self):
        ...
        self.level_image = self.font.render("等级: "+str(self.status.level), True, self.text_color, 
                                                     self.ai_settings.bg_color)
